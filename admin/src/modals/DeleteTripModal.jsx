...
export default function DeleteTripModal({ trip, onConfirm, onCancel }) {
  if (!trip) return null;
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
        <div className="rounded-2xl w-full max-w-sm bg-white backdrop-blur-none border border-red-500/25 shadow-[0_24px_64px_rgba(0,0,0,0.12)] pointer-events-auto">
          <div className="p-6 flex flex-col items-center text-center gap-4">
            ...
            <div>
              <h3 className="text-[15px] font-black text-[#111827]">Delete Booking?</h3>
              <p className="text-[12px] text-[#111827]/45 mt-2 leading-relaxed">
                Are you sure you want to delete trip{" "}
                <span className="text-[#111827] font-bold">{trip.displayId}</span>?
